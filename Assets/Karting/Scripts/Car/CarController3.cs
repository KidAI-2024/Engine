...
namespace Karting.Car
{
    public class CarController3 : MonoBehaviour
    {
        ...
        public List<MeshRenderer> m_VisualWheels;
        ...
        {
            UpdateWheelPosition(FrontLeftWheel, m_VisualWheels[0]);
            UpdateWheelPosition(FrontRightWheel, m_VisualWheels[1]);
            UpdateWheelPosition(RearLeftWheel, m_VisualWheels[2]);
            UpdateWheelPosition(RearRightWheel, m_VisualWheels[3]);
        }
